const TOUR_SLIDES = [
  ...
  // ── 4: THE MENU ──
  {
    title: 'Your Menu & Profile',
    body: () => `
      <p class="tour-desc">Tap the <strong>☰ button in the top-left</strong> to open your personal menu. It shows your logged-in profile, the main app tools, and the Log Out button.</p>
      <div class="demo-area">
  ...
  // ── 5: QUICK MAP BUTTONS ──
  {
    title: 'Map Controls',
    body: () => `
      <p class="tour-desc">Four quick controls sit on the <strong>bottom-right</strong> of the map for tools you may need while viewing sirens.</p>
      <div class="demo-area">
        <div class="demo-label">Right-side map controls</div>
